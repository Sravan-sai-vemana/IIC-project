  ...
  <div class="MainBody">
    ...
    <a href="ach_search.php" id="filter">Search</a>
        ...
        <table border="3" id="table1">
            ...
            <?php
        $query = "(SELECT date, teamName, category, eventName, position, Level, amount FROM achievements WHERE teamName != 'Individual' GROUP BY date, teamName, eventName) UNION ALL (SELECT date, teamName, category, eventName, position, Level, amount FROM achievements WHERE teamName = 'Individual')";
