...
<body>
  <div class="MainBody">
    ...
    <center>
    <p id="achi"><?php echo $_POST['Category'] ?></p>
    ...
    <a href="ach_search.php" id="filter">Search</a>
        ...
        <table border="3" id="table1">
            ...
            <?php
        $query = "(SELECT date, teamName, category, eventName, position, Level, amount FROM achievements WHERE teamName != 'Individual' and Category='".$_POST['Category']."' GROUP BY date, teamName, eventName) UNION ALL (SELECT date, teamName, category, eventName, position, Level, amount FROM achievements WHERE teamName = 'Individual' and Category='".$_POST['Category']."')";
