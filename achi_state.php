...
<body>
  <div class="MainBody">
    ...
    <center>
    <p id="achi">ACHIEVEMENTS - STATE LEVEL</p>
    ...
    <a href="ach_search.php" id="filter">Search</a>
        ...
        <table border="3" id="table1">
            ...
            <?php
        $query = "(SELECT date, teamName, category, eventName, position, Level, amount FROM achievements WHERE teamName != 'Individual' and Level='State' GROUP BY date, teamName, eventName) UNION ALL (SELECT date, teamName, category, eventName, position, Level, amount FROM achievements WHERE teamName = 'Individual' and Level='State')";
